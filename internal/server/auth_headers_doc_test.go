...
func TestAuthRejectionHeadersDocumentation(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			setupRequest: func() *http.Request {
				return createTestRequest("GET", "/test-bucket/test-key", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
			},
		...
		},
		{
			...
			setupRequest: func() *http.Request {
				...
				return createTestRequest("GET", "/test-bucket/test-key", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", &oldTime)
			},
		...
		},
		{
			...
			setupRequest: func() *http.Request {
				return createMalformedSigRequestForDoc("GET", "/test-bucket/test-key", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE")
			},

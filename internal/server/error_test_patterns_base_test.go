...
func createInvalidSignatureRequest(t *testing.T) *http.Request {
	t.Helper()
	req := createSignedRequestForAuthTest(t, "GET", "/test-bucket/key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
...
func createExpiredRequest(t *testing.T) *http.Request {
	...
	return createSignedRequestForAuthTest(t, "GET", "/test-bucket/key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", &oldTime)
}

// createNotFoundRequest creates a request for a non-existent resource.
func createNotFoundRequest(t *testing.T) *http.Request {
	t.Helper()
	return createSignedRequestForAuthTest(t, "GET", "/test-bucket/nonexistent", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
}
...
func createMethodNotAllowedRequest(t *testing.T) *http.Request {
	t.Helper()
	return createSignedRequestForAuthTest(t, "POST", "/test-bucket/key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
}
...
func createUnsupportedMediaTypeRequest(t *testing.T) *http.Request {
	t.Helper()
	body := `{"data": "test"}`
	return createSignedRequestForAuthTest(t, "PUT", "/test-bucket/key", body, "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
}
...
func createInternalErrorRequest(t *testing.T) *http.Request {
	...
	return createSignedRequestForAuthTest(t, "GET", "/test-bucket/.armor/internal-trigger", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
}

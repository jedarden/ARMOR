...
func TestAuthIntegration(t *testing.T) {
	...
	t.Run("Valid SigV4 authentication is accepted", func(t *testing.T) {
		req := createSignedRequestForAuthTest(t, "GET", "/test-bucket/test-key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
	...
	t.Run("Expired request is rejected", func(t *testing.T) {
		...
		req := createSignedRequestForAuthTest(t, "GET", "/test-bucket/test-key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", &oldTime)
	...
	t.Run("Multiple credentials work", func(t *testing.T) {
		...
		req1 := createSignedRequestForAuthTest(t, "GET", "/test-bucket/key1", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)

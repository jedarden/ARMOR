...
func NotFoundScenario() ErrorScenario {
	return ErrorScenario{
		...
		SetupRequest: func(t *testing.T) *http.Request {
			return createSignedRequestForAuthTest(t, "GET", "/test-bucket/nonexistent-key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
		},
		ExpectedStatus:   404,
...
func NotFoundWithBucketScenario(bucket string) ErrorScenario {
	return ErrorScenario{
		...
		SetupRequest: func(t *testing.T) *http.Request {
			return createSignedRequestForAuthTest(t, "GET", "/"+bucket+"/key", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
		},
		ExpectedStatus:   404,
		ExpectedCode:     ErrorCodeNoSuchKey,
...
func InternalServerErrorScenario() ErrorScenario {
	return ErrorScenario{
		...
		SetupRequest: func(t *testing.T) *http.Request {
			...
			return createSignedRequestForAuthTest(t, "GET", "/test-bucket/key-that-does-not-exist", "", "TESTACCESSKEY", "REMOVED-NOT-A-SECRET-VALUE", nil)
		},
		ExpectedStatus:   500,

...
func TestValidationErrorPathFormatting_SimplePaths(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewValidationError("config.yaml", "test message", tt.fieldPath, "constraint", ErrCodeValidationFailed, 0, 0, ErrorTypeValidation, "", "", "")
			errorMsg := err.Error()
...
func TestValidationErrorPathFormatting_WithLineAndColumn(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewValidationError("config.yaml", "test message", tt.fieldPath, "constraint", ErrCodeValidationFailed, tt.line, tt.column, ErrorTypeValidation, "", "", "")
			errorMsg := err.Error()
...
func TestValidationErrorPathFormatting_ExactFormat(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewValidationError("config.yaml", tt.message, tt.fieldPath, tt.constraint, ErrCodeValidationFailed, tt.line, tt.column, ErrorTypeValidation, "", "", "")
			errorMsg := err.Error()
...
func TestValidationErrorPathFormatting_StringMethod(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewValidationError("config.yaml", "test message", tt.fieldPath, tt.constraint, ErrCodeValidationFailed, tt.line, tt.column, ErrorTypeValidation, "", "", "")
			result := err.String()
...
func TestValidationErrorPathFormatting_RealWorldExamples(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewValidationError("k8s-deployment.yaml", "invalid value", tt.fieldPath, "constraint", ErrCodeValidationFailed, 10, 5, ErrorTypeValidation, "", "", "")
			errorMsg := err.Error()

...
2026-07-12 ~01:45 UTC (retry #17 - same RBAC blocker persists, prerequisite still not met, base64 -d fails with "invalid input", file contains 723 bytes of error text not base64 data, no progress)

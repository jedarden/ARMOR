# Complete Pluck Debug Command Reference

**Bead:** bf-7423  
**Date:** 2026-07-09  
**Task:** Construct Pluck debug command with all required debug flags and options

## Executive Summary

Pluck (NEEDLE's strand filtering system) uses **environment variables only** for debug control - there are NO CLI debug flags. The complete command structure combines `RUST_LOG` environment variable configuration with standard `needle run` CLI options.
...
- **debug** - Detailed debugging information (recommended)
...
- This document: `/home/coding/ARMOR/notes/bf-7423-pluck-debug-command-reference.md`

✅ **Each debug flag's purpose documented**
- RUST_LOG levels explained
- Module paths documented
- Expected output events described

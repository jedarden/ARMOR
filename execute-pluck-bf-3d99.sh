...
# Script to execute Pluck with debug logging for bead bf-3d99
set -e

OUTPUT_FILE="logs/pluck-debug/pluck-debug-bf-3d99-capture-$(date +%Y%m%d-%H%M%S).log"

echo "=== Pluck Debug Execution Capture for bf-3d99 ==="
